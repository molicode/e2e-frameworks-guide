...
I18n.register("es", {
  ...
  "iv.selenium.a1": "Uso esperas explícitas (WebDriverWait + expected_conditions) por condiciones concretas, en vez de sleeps fijos; la implícita, con cuidado.",
  "iv.selenium.q2": "Contame cómo estructurarías un proyecto de automatización con Selenium.",
  "iv.selenium.a2": "Con Page Objects para encapsular páginas, un runner como pytest, datos de prueba separados, selectores estables (id/data-*) y reporte.",
  "iv.selenium.q3": "¿Cómo localizarías un elemento que no tiene id ni clase estable?",
  "iv.selenium.a3": "Por atributos semánticos (name, aria-label, texto) o relaciones cercanas; evito el XPath posicional que se rompe fácil.",
  "iv.selenium.q4": "¿Cómo corrés Selenium en CI y en paralelo?",
  "iv.selenium.a4": "En un pipeline con navegador headless; en paralelo con Selenium Grid o pytest-xdist.",
  "iv.selenium.q5": "¿Ventajas y desventajas frente a Playwright o Cypress?",
  "iv.selenium.a5": "Ventaja: estándar maduro, multi-lenguaje y multi-navegador. Desventaja: más verboso y sin auto-wait nativo, hay que manejar las esperas.",
  "iv.selenium.q6": "¿Cómo validás una respuesta de API dentro de un flujo de Selenium?",
  "iv.selenium.a6": "Selenium es de UI; para la API uso requests y verifico el status_code y el body por separado.",

  "iv.cypress.q1": "¿Por qué en Cypress no usás async/await?",
  "iv.cypress.a1": "Los comandos se encolan y ejecutan en orden; Cypress maneja la asincronía. Si necesito el valor resuelto, uso .then().",
  "iv.cypress.q2": "¿Cómo evitás la flakiness en Cypress?",
  "iv.cypress.a2": "Aprovecho el retry automático de .should(), evito waits fijos, uso cy.intercept() para esperar requests y selectores data-cy.",
  "iv.cypress.q3": "¿Cómo mockeás el backend?",
  "iv.cypress.a3": "Con cy.intercept() para stubbear respuestas y controlar estados (errores, listas vacías, loading).",
  "iv.cypress.q4": "¿Qué limitaciones de Cypress tenés en cuenta?",
  "iv.cypress.a4": "Un solo origen/pestaña por test y multi-tab limitado; conviene diseñar los tests alrededor de eso.",
  "iv.cypress.q5": "¿Cómo mantenés selectores estables?",
  "iv.cypress.a5": "Con atributos data-cy dedicados, desacoplados de clases y estilos que cambian.",
  "iv.cypress.q6": "¿Cómo testeás endpoints sin UI?",
  "iv.cypress.a6": "Con cy.request(), verificando el status y el body.",

  "iv.playwright.q1": "¿Qué es el auto-waiting y por qué importa?",
  "iv.playwright.a1": "Playwright espera a que el elemento esté accionable antes de actuar; reduce flakiness y elimina los sleeps manuales.",
  "iv.playwright.q2": "¿Cómo depurás un test que falla en CI pero no localmente?",
  "iv.playwright.a2": "Con el trace viewer: reviso DOM, red y screenshots paso a paso de la corrida que falló.",
  "iv.playwright.q3": "¿Qué locators preferís y por qué?",
  "iv.playwright.a3": "get_by_role / get_by_label / get_by_text: resilientes y centrados en el usuario, en vez de CSS o XPath frágil.",
  "iv.playwright.q4": "¿Cómo testeás en varios navegadores?",
  "iv.playwright.a4": "Configuro proyectos para Chromium, Firefox y WebKit; los mismos tests corren en cada motor.",
  "iv.playwright.q5": "¿Cómo manejás la autenticación entre tests?",
  "iv.playwright.a5": "Guardo el storage state tras loguear una vez y lo reuso, evitando el login en cada test.",
  "iv.playwright.q6": "¿Cómo testeás una API con Playwright?",
  "iv.playwright.a6": "Con el request context (api.get/post/...), sin abrir navegador, verificando el status.",

  "iv.robot.q1": "¿Cuándo elegirías Robot Framework?",
  "iv.robot.a1": "Cuando quiero tests legibles por no-programadores, reutilización por keywords y el ecosistema de librerías.",
  "iv.robot.q2": "¿Cómo mantenés los tests DRY en Robot?",
  "iv.robot.a2": "Con keywords de usuario que agrupan pasos y con Resource files compartidos.",
  "iv.robot.q3": "¿Cómo manejás los datos de prueba?",
  "iv.robot.a3": "Con variables, Variables files, o data-driven usando Test Templates.",
  "iv.robot.q4": "¿Cómo testeás APIs en Robot?",
  "iv.robot.a4": "Con RequestsLibrary: Create Session y GET/POST/... On Session, más Status Should Be.",
  "iv.robot.q5": "¿SeleniumLibrary o Browser library?",
  "iv.robot.a5": "SeleniumLibrary es clásica y estable; Browser (basada en Playwright) da auto-wait y velocidad. Elijo según el proyecto.",
  ...
  "iv.role.q": "Entrevistador",
  "iv.role.a": "Tu respuesta",
