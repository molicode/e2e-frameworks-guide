...
I18n.register("es", {
  ...
  "aiqa.nav.flows": "Flujos",
  "cpt.flow": "Cómo funciona",
  "flow.rag.title": "RAG — Retrieval-Augmented Generation",
  "flow.rag.s0.t": "Pregunta",
  "flow.rag.s0.d": "El usuario (o el sistema) hace una pregunta en lenguaje natural, por ejemplo: «¿qué casos cubren el login?».",
  "flow.rag.s1.t": "Embedding",
  "flow.rag.s1.d": "El texto se convierte en un vector numérico que captura su significado, no solo sus palabras.",
  "flow.rag.s2.t": "Búsqueda vectorial",
  "flow.rag.s2.d": "Se recuperan de la base vectorial los fragmentos más parecidos: docs, specs, código, tickets.",
  "flow.rag.s3.t": "Aumentar el prompt",
  "flow.rag.s3.d": "Esos fragmentos se inyectan como contexto junto a la pregunta original.",
  "flow.rag.s4.t": "El LLM responde",
  "flow.rag.s4.d": "El modelo redacta la respuesta apoyándose en el contexto recuperado, no solo en su memoria.",
  "flow.rag.s5.t": "Respuesta con fuentes",
  ...
  "flow.agent.s2.d": "Ejecuta una acción real: abrir el navegador, correr un comando, leer o editar un archivo.",
  "flow.agent.s3.t": "Observa",
  "flow.agent.s3.d": "Lee el resultado real —DOM, logs, código de salida— para saber qué pasó de verdad.",
  "flow.agent.s4.t": "Reflexiona y repite",
  "flow.agent.s4.d": "Compara con el objetivo; si falta algo, ajusta el plan y vuelve a actuar. Este ciclo se repite.",
  "flow.agent.s5.t": "Termina",
  "flow.agent.s5.d": "Cuando el objetivo se cumple, entrega el resultado y se detiene.",
  "flow.selfheal.title": "Self-healing locators",
  "flow.selfheal.s0.t": "El locator falla",
  "flow.selfheal.s0.d": "El selector #login-btn ya no existe: el front cambió y el test se rompería.",
  "flow.selfheal.s1.t": "La AI lee el DOM",
  "flow.selfheal.s1.d": "En vez de fallar, examina la página actual y los atributos disponibles del elemento.",
  "flow.selfheal.s2.t": "Propone un selector",
  "flow.selfheal.s2.d": "Encuentra el elemento equivalente por rol, texto o atributos estables.",
  "flow.selfheal.s3.t": "Reintenta",
  "flow.selfheal.s3.d": "Ejecuta el paso con el locator sano y el flujo continúa sin romperse.",
  "flow.selfheal.s4.t": "Reporta el cambio",
  "flow.selfheal.s4.d": "Deja registro del selector viejo → nuevo para que un humano lo revise y lo confirme.",
  "flow.hitl.title": "Human-in-the-loop",
  "flow.hitl.s0.t": "La AI genera",
  "flow.hitl.s0.d": "El modelo produce algo: tests, datos de prueba o un locator candidato.",
  "flow.hitl.s1.t": "Se presenta",
  "flow.hitl.s1.d": "La propuesta se muestra para revisión; no se aplica sola a ciegas.",
  "flow.hitl.s2.t": "El humano revisa",
  "flow.hitl.s2.d": "Aprueba, corrige o rechaza; aporta el criterio y el contexto que el modelo no tiene.",
  "flow.hitl.s3.t": "Se aprueba",
  "flow.hitl.s3.d": "Solo lo validado entra al repositorio o a la suite de tests.",
  "flow.hitl.s4.t": "El feedback mejora",
  ...
  "flow.gen.s2.d": "Produce un borrador de tests: happy path más los casos borde que quizás olvidaste.",
  "flow.gen.s3.t": "Revisión humana",
  ...
  "flows.agent.lead": "<p>Lo que distingue a un agente de un simple prompt: no responde y ya, sino que actúa, observa el resultado y vuelve a intentar hasta cumplir el objetivo.</p>",
  "flows.hitl.lead": "<p>El principio de seguridad que sostiene todo lo demás: la AI propone, pero una persona revisa y decide qué se aplica.</p>",
  "flows.callout": "Regla de oro: la AI acelera el trabajo, no reemplaza el criterio. En todos estos flujos hay —o debería haber— un humano validando los puntos que importan.",

  /* ---- AI concepts (glossary expansion) ---- */
  "kt.ai.embeddings": "Representación de un texto como un vector de números que captura su significado: textos parecidos quedan cerca en ese espacio.",
  ...
  "cpt.ai-guardrails.uc": "Convierten una salida «creativa» en una segura y usable. QA verifica que los guardrails <strong>realmente frenen</strong> las entradas y salidas peligrosas, no solo los casos felices.",
  "kt.ai.temperature": "Parámetro que controla la aleatoriedad al elegir la próxima palabra: baja = predecible y estable; alta = creativa y variada.",
  ...
  "flow.evals.s2.d": "Un evaluador —a veces otro LLM— puntúa cada salida contra criterios claros y explícitos.",
  "flow.evals.s3.t": "Puntaje",
  "flow.evals.s3.d": "Se agregan los resultados: % que pasa, dónde falla, comparación contra la versión anterior.",
  "flow.evals.s4.t": "Umbral / gate",
  "flow.evals.s4.d": "Si el puntaje baja del umbral, no se promueve ese prompt o modelo. Es regresión, pero para la IA.",
  "flow.injection.title": "Prompt injection — el ataque",
  "flow.injection.s0.t": "Entrada maliciosa",
  "flow.injection.s0.d": "Un texto controlado por el atacante llega al sistema: un comentario, un email, un campo del formulario.",
  "flow.injection.s1.t": "Se mezcla en el prompt",
  "flow.injection.s1.d": "Esa entrada se concatena con tus instrucciones sin separar «datos» de «órdenes».",
  "flow.injection.s2.t": "El modelo obedece",
  "flow.injection.s2.d": "Toma la entrada como instrucción: ignora su tarea, filtra datos o ejecuta algo indebido.",
  "flow.injection.s3.t": "Acción no deseada",
  "flow.injection.s3.d": "Fuga de información, acciones destructivas o respuestas fuera de política.",
  "flow.injection.s4.t": "Mitigación",
  "flow.injection.s4.d": "Separar datos de instrucciones, validar la salida y limitar los permisos del agente (menor privilegio).",
