...
I18n.register("en", {
  ...
  "iv.selenium.a1": "I use explicit waits (WebDriverWait + expected_conditions) for specific conditions instead of fixed sleeps; implicit waits carefully.",
  "iv.selenium.q2": "Tell me how you'd structure a Selenium automation project.",
  "iv.selenium.a2": "With Page Objects to encapsulate pages, a runner like pytest, separate test data, stable selectors (id/data-*) and reporting.",
  "iv.selenium.q3": "How would you locate an element with no stable id or class?",
  "iv.selenium.a3": "By semantic attributes (name, aria-label, text) or nearby relationships; I avoid positional XPath that breaks easily.",
  "iv.selenium.q4": "How do you run Selenium in CI and in parallel?",
  "iv.selenium.a4": "In a pipeline with a headless browser; in parallel with Selenium Grid or pytest-xdist.",
  "iv.selenium.q5": "Pros and cons versus Playwright or Cypress?",
  "iv.selenium.a5": "Pro: a mature, multi-language and multi-browser standard. Con: more verbose and no native auto-wait, so you manage the waits.",
  "iv.selenium.q6": "How do you validate an API response within a Selenium flow?",
  "iv.selenium.a6": "Selenium is UI; for the API I use requests and check the status_code and body separately.",

  "iv.cypress.q1": "Why don't you use async/await in Cypress?",
  "iv.cypress.a1": "Commands are queued and run in order; Cypress manages the async. If I need the resolved value I use .then().",
  "iv.cypress.q2": "How do you avoid flakiness in Cypress?",
  "iv.cypress.a2": "I lean on .should()'s auto-retry, avoid fixed waits, use cy.intercept() to wait on requests, and data-cy selectors.",
  "iv.cypress.q3": "How do you mock the backend?",
  "iv.cypress.a3": "With cy.intercept() to stub responses and control states (errors, empty lists, loading).",
  "iv.cypress.q4": "What Cypress limitations do you keep in mind?",
  "iv.cypress.a4": "A single origin/tab per test and limited multi-tab; I design the tests around that.",
  "iv.cypress.q5": "How do you keep selectors stable?",
  "iv.cypress.a5": "With dedicated data-cy attributes, decoupled from classes and styles that change.",
  "iv.cypress.q6": "How do you test endpoints with no UI?",
  "iv.cypress.a6": "With cy.request(), checking the status and body.",

  "iv.playwright.q1": "What is auto-waiting and why does it matter?",
  "iv.playwright.a1": "Playwright waits for the element to be actionable before acting; it reduces flakiness and removes manual sleeps.",
  "iv.playwright.q2": "How do you debug a test that fails in CI but not locally?",
  "iv.playwright.a2": "With the trace viewer: I review DOM, network and screenshots step by step of the failed run.",
  "iv.playwright.q3": "Which locators do you prefer and why?",
  "iv.playwright.a3": "get_by_role / get_by_label / get_by_text: resilient and user-centric, instead of brittle CSS or XPath.",
  "iv.playwright.q4": "How do you test across multiple browsers?",
  "iv.playwright.a4": "I configure projects for Chromium, Firefox and WebKit; the same tests run on each engine.",
  "iv.playwright.q5": "How do you handle authentication across tests?",
  "iv.playwright.a5": "I save the storage state after logging in once and reuse it, avoiding login in every test.",
  "iv.playwright.q6": "How do you test an API with Playwright?",
  "iv.playwright.a6": "With the request context (api.get/post/...), without opening a browser, checking the status.",

  "iv.robot.q1": "When would you choose Robot Framework?",
  "iv.robot.a1": "When I want tests readable by non-programmers, keyword reuse and the library ecosystem.",
  "iv.robot.q2": "How do you keep Robot tests DRY?",
  "iv.robot.a2": "With user keywords that group steps and shared Resource files.",
  "iv.robot.q3": "How do you handle test data?",
  "iv.robot.a3": "With variables, Variables files, or data-driven using Test Templates.",
  "iv.robot.q4": "How do you test APIs in Robot?",
  "iv.robot.a4": "With RequestsLibrary: Create Session and GET/POST/... On Session, plus Status Should Be.",
  "iv.robot.q5": "SeleniumLibrary or Browser library?",
  "iv.robot.a5": "SeleniumLibrary is classic and stable; Browser (built on Playwright) gives auto-wait and speed. I pick per project.",
  "iv.robot.q6": "How do you integrate Robot into CI?",
  "iv.robot.a6": "I run robot from the pipeline, publish the HTML report/log as an artifact and fail the build on red tests.",
  ...
  "iv.role.q": "Interviewer",
  "iv.role.a": "Your answer",
